...
type PropsType = {
    entityTitle: string //pack or card
    open: boolean
    onClose: boolean
}

export const AddModal: FC<PropsType> = memo(({open, onClose, entityTitle}) => {
    ...
    return (
        <>
            <Button variant={'contained'} color={'primary'}>{`Add new ${entityTitle}`}</Button>
            <BasicModal open={open} onClose={()=>onClose}>
                <InputLabel>Name {entityTitle}</InputLabel>
